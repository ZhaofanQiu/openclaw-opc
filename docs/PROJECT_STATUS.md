...
| 优先级 | 功能 | 说明 | 工作量 |
|--------|------|------|--------|
| 🔴 P0 | **Partner自动创建Agent** | 无需手动编辑openclaw.json | 5天 |
| 🔴 P0 | **外网安全访问** | API Key认证 + 分享链接 | 3天 |
| 🔴 P0 | **精确Token统计** | 通过session_status获取真实消耗 | 3天 |
| 🔴 P0 | **PostgreSQL迁移** | 多用户场景支持 | 5天 |
| 🟠 P1 | **像素头像V2** | 个性化AI生成头像 | 5天 |
| 🟠 P1 | **图表可视化** | 报表添加趋势图、饼图 | 3天 |
| 🟠 P1 | **熔断后选项** | 追加预算/拆分任务/换人 | 2天 |
| 🟡 P2 | **Agent间通信** | Partner通过sessions_send通知员工 | 3天 |
